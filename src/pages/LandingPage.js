...
const LandingPage = () => {
  return (
    <>
      <section
        class="text-gray-600 body-font sm:mt-24 mt-64 "
        style={{
          ...
          <div class="flex flex-wrap -m-4">
            <div class="xl:w-1/4 md:w-1/2 p-4">
              <div class="bg-gray-100 p-6 rounded-lg">
                <img
                  class="h-auto rounded w-full object-cover object-center mb-6"
                  src={img1}
                  alt="content"
                />
                ...
                <p class="leading-relaxed font-bold mt-4 text-base">244$</p>
              </div>
            </div>
            <div class="xl:w-1/4 md:w-1/2 p-4">
              <div class="bg-gray-100 p-6 rounded-lg">
